...
class Code128
{
    ...
    /**
     * Prints code to PDF document given coordinates and size
     *
     * @param float $x Barcode horizontal position based on left side page.
     * @param float $y Barcode vertical position based on top page.
     * @param string $code ASCII text to convert to barcode
     * @param float $w Barcode total width
     * @param float $h Barcode total height
     * @return void
     */
    function Draw(float $x, float $y, string $code, float $w, float $h) {
